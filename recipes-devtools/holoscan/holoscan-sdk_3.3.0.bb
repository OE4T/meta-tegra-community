...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/sources-unpack/desktop-icons/*.desktop ${D}${datadir}/applications
    install -d ${D}${datadir}/pixmaps
    install -m 0644 ${WORKDIR}/sources-unpack/desktop-icons/*.png ${D}${datadir}/pixmaps
}
