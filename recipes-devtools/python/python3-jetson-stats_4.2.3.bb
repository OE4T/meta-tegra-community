...
SYSTEMD_SERVICE_${PN} = "jtop.service"

USERADD_PACKAGES = "${PN}"
USERADD_PARAM_${PN} = "-r -d ${libexecdir} -M -s ${base_sbindir}/nologin -g jtop jtop"
GROUPADD_PARAM_${PN} = "-f -r jtop"
