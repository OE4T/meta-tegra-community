...
DEPENDS = "glib-2.0 gstreamer1.0 gstreamer1.0-plugins-base gstreamer1.0-rtsp-server \
    ...
    openssl tegra-libraries-multimedia \
"
...
FILES_${PN}-azure = "${DEEPSTREAM_PATH}/lib/libiothub_client.so ${DEEPSTREAM_PATH}/lib/libnvds_azure*"
FILES_${PN}-triton = "\
...
FILES_${PN}-rivermax = "${libdir}/gstreamer-1.0/deepstream/libnvdsgst_udp.so"

RDEPENDS_${PN} = "libvisionworks-devso-symlink"
